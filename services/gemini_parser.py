...
3. เลขกรมธรรม์ (policy_number): ⚠️ จุดผิดบ่อยที่สุด — อ่านอย่างละเอียด
   - คัดลอก **ทั้งตัวอักษร เลข ขีด สแลช** ตามเอกสารเป๊ะ
   - "/" (slash) ≠ "-" (dash)  อย่าแปลง
   - **ตัวอักษรอังกฤษพิมพ์ใหญ่ที่นำหน้า อย่าอ่านเป็นตัวเลข:**
       - "D" ≠ "0" ≠ "2"  (D มีโค้งและขีดตรง, ไม่ใช่วงกลม)
       - "B" ≠ "8" ≠ "3"  (B มีโค้ง 2 ห่วง)
       - "O" (โอ) ≠ "0" (ศูนย์)  (O ตัวหนาเท่ากัน, 0 อาจมีขีดทแยง)
       - "I" ≠ "1" ≠ "l"
       - "S" ≠ "5"
       - "Z" ≠ "2"
   - **เลขกรมธรรม์ส่วนใหญ่ขึ้นต้นด้วย "ตัวอักษรอังกฤษ" 1-2 ตัว** เช่น D, M, B, K, R
   - ดูบริบท: ตัวแรกของ policy number อยู่หลังคำว่า "Policy No." หรือใต้หัวข้อ "กรมธรรม์เลขที่"
   - ตัวอย่างถูก: "D0-70-69/008599", "M 1690097208", "725-01333-53214", "210001/1003059347/135-M4"
   - ตัวอย่างผิด: "20-70-69/008599" (อ่าน D เป็น 2), "B 1690097208" → "8 1690097208"
   - **เปรียบเทียบ 2 จุดในเอกสาร** — barcode bottom + ตาราง "เลขที่" → ต้องตรงกัน
